...
# Notes: Hugo had created the data and generating scripts, here
# I gathers all the commands to run it again faster. Also, I added 
# some csv files.

# The data/clean contains the simulation and the clean linelists in .RDS
...
# The clean data is in rds format for now
